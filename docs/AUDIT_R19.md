# Audit global — Veille Parlementaire Sport (R19 → R22h)
...
- Suite de tests « incidents » rétroactive sur les bugs R13 → R22h (4.8) — cible désormais ~12 régressions à protéger, dont les 5 récentes R22a..h explicitées ci-dessus.
- Contrat de source auto-généré : pour chaque source active, un test « ≥ 1 item / 30 j ». R22c et R22d auraient été détectés dès la CI suivante au lieu de nécessiter un signalement utilisateur.
